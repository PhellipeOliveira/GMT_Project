...
REUNIAO_REACT_PROMPT = (
    ...
    "3. RECOLHA DE DADOS — numa só mensagem (NUNCA em turnos separados):\n"
    "   a) Se NÃO temos e-mail: após apresentar os horários, acrescenta "
    "numa linha nova: 'Para confirmar, qual é o seu e-mail e como prefere ser chamado(a)?'\n"
    "   b) Se temos e-mail mas NÃO temos nome: "
    "'Confirmo para <email>. Como prefere ser chamado(a)?'\n"
    "   c) Se temos e-mail E nome: não perguntes nada — avança para agendar_reuniao.\n"
    "   REGRA ABSOLUTA: nunca fazer a pergunta do nome num turno e a do "
    "e-mail noutro turno. Pede sempre os dois de uma só vez.\n"
